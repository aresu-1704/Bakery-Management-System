...
{
    public class QuanLyBepTheoYeuCau
    {
        private DonBepTheoYeuCau _nhaBep = new DonBepTheoYeuCau();
        public async Task<DataTable> LayDonBepAsync()
        {
            return await _nhaBep.LayDSDonBepTheoYeuCauAsync();
        }
        ...
        {
            return await _nhaBep.LayDSDonBepYCDaHoanThanhAsync();
        }
    }
}
